          ...
          {false && (
            <View style={styles.actionButtons}>
              ...
              {!isClaimed ? (
                ...
                <>
                  <TouchableOpacity
                    style={[styles.claimButton, { backgroundColor: '#FFC107', marginBottom: 8 }]}
                  ...
                  <TouchableOpacity
                    style={[styles.claimButton, { backgroundColor: '#EF5350' }]}
                    onPress={handleCancelClaim}
                    accessibilityLabel="Cancel claim"
                    accessibilityRole="button"
                  >
                    <Icon name="cancel" size={20} color={theme.colors.surface} />
                    <Text style={[styles.claimButtonText, { color: theme.colors.surface }]}>Cancel Claim</Text>
                  </TouchableOpacity>
                </>
              ) : (
